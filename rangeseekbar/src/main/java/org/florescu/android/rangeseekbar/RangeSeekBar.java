...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#1AB188");
    /**
    ...
    public static Integer DEFAULT_MAXIMUM = 1000;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mDefaultColor = Color.parseColor("#cbcbcb");
            mAlwaysActive = false;
            mShowTextAboveThumbs = true;
            mTextAboveThumbsColor = Color.parseColor("#000");
            ...
            try {
                ...
                mTextAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#1AB188"));
                ...
                barHeight = a.getDimensionPixelSize(R.styleable.RangeSeekBar_barHeight,5);
                mActiveColor = a.getColor(R.styleable.RangeSeekBar_activeColor, Color.parseColor("#1AB188"));
                mDefaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, Color.parseColor("#cbcbcb"));
